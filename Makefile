...
server: ServerGateway.cpp
	$(CC) $(CFLAGS) ServerGateway.cpp MainMenu.cpp ServerStats.cpp ServerStats.h StringParser.cpp StringParser.h KeyValue.cpp KeyValue.h HeadsTailsServer.cpp GameClass2.cpp GameClass2.h ClientGame2.cpp -o serverGateway -lpthread
