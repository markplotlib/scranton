...
server: ServerGateway.cpp
	$(CC) $(CFLAGS) ServerGateway.cpp MainMenu.cpp ServerStats.cpp ServerStats.h StringParser.cpp StringParser.h KeyValue.cpp KeyValue.h HeadsTails.cpp -o serverGateway -lpthread
